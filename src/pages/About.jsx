        ...
        <section className='bg-richblack-700'>
            <div className='relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white'>
                <header className='mx-auto py-20 text-4xl font-semibold lg:w-[70%]'>
                  ...
                  <p className='mx-auto mt-3 text-center text-base font-medium text-richblack-300 lg:w-[95%]'>CodePlay is at the forefront of driving innovation in online
                ...
                <div className='absolute bottom-0 left-[50%] grid w-[100%] translate-x-[-50%] translate-y-[30%] grid-cols-3 gap-3 lg:gap-5 '>
                    <img src={BannerImage1} className='rounded-md'/>
                    <img src={BannerImage2} className='rounded-md'/>
                    <img src={BannerImage3} className='rounded-md'/>
                </div>
            </div>
        </section>
        ...
        <section>
            <div className='mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-500'>
                <div className='flex flex-col items-center gap-10 lg:flex-row justify-between'>
                    ...
                    <div>
                        <img src={FoundingStory} alt='' className='shadow-[0_0_40px_0] shadow-[#FC6767] rounded-md'/>
                    </div>
