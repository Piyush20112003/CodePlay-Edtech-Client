    ...
    <div className='flex h-[calc(100vh-3.5rem)] w-[320px] max-w-[350px] flex-col border-r-[1px] border-r-richblack-700 bg-richblack-800'>
        <div className='mx-5 flex flex-col items-start justify-between gap-2 gap-y-4 border-b border-richblack-600 py-5 text-lg font-bold text-richblack-25'>
            <div className='flex w-full items-center justify-between '>
              ...
              }} className='flex h-[35px] w-[35px] items-center justify-center rounded-full hover:bg-richblack-700 p-1 text-richblack-25 hover:scale-90 transition-all text-xs' title='back'>
            ...
            <div className='flex flex-col'>
                <p className='text-caribbeangreen-200'>{courseEntireData?.courseName}</p>
                    ...
                    <div className='flex flex-row justify-between bg-richblack-600 px-5 py-4'>
                        ...
                        <div className='flex items-center gap-3'>
                            ...
                            <span className={`${
                             ...
                             ? "rotate-0"
                             : "rotate-180"
                            } transition-all duration-500`}> <BsChevronDown/>          
                            </span>
                        </div>
                    </div>
