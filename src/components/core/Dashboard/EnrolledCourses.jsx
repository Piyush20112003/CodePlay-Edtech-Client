...
const EnrolledCourses = () => {
 ...
 useEffect(() => {
  ...
  return (
    <>
     <div className='ext-3xl text-richblack-50'>Enrolled Courses</div>
      {
        !enrolledCourses ? (
               ...
               {enrolledCourses.map((course, i , arr) => (
                <div className={`flex items-center border border-richblack-700 ${
                  ...
                  key={i}>
                     ...
                     onClick={() => {
                       ...
                       `/view-course/${course?._id}/section/${course.courseContent?.[0]?._id}/sub-section/${course.courseContent?.[0]?.subSection?.[0]?._id}`
                        ...
                        <div className='flex max-w-xs flex-col gap-2'>
                            <p className='font-semibold text-caribbeangreen-200'>{course.courseName}</p>
                    ...
                    <div className='w-1/4 px-2 py-3 text-blue-300'>{course?.totalDuration}</div>
